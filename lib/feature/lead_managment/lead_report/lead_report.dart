                        ...
                        if (state.listStatus == LeadListStatus.failure) {
                          return Padding(
                            ...
                            child: Text(
                              state.listError ?? 'Something went wrong.',
                              style:
                                  AppTextStyle.medium(color: Colors.red),
                            ),
                          );
                        }
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "Showing 0 to 0 of 0 entries",
                            style:
                                AppTextStyle.medium(weight: FontWeight.w400),
                          ),
                          Row(
                            children: [
                              Container(
  ...
  void _confirmDelete(BuildContext ctx, AddLeadModel lead) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title:
            Text('Delete Lead', style: AppTextStyle.medium(size: 14.sp)),
        content: Text(
          'Are you sure you want to delete "${lead.clientName}"? This action cannot be undone.',
          style: AppTextStyle.medium(),
        ),
