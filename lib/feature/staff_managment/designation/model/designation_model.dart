...
// // ─────────────────────────────────────────────
// // Firestore Repository (CRUD helpers)
// // ─────────────────────────────────────────────
...
//     assert(designation.id != null, 'Designation ID must not be null for update');
...
//   /// Stream all designations
//   Stream<List<DesignationModel>> streamAll() {
//     return _collection
//         .orderBy('createdAt', descending: true)
//         .snapshots()
//         .map((snap) =>
//             snap.docs.map(DesignationModel.fromFirestore).toList());
//   }

//   /// Get all designations once
