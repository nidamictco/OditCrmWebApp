...
import '../lead_managment/follow_up/data/activity_repo.dart';
import '../lead_managment/leads/cubit/add_lead_cubit.dart';
import '../lead_managment/leads/cubit/add_lead_state.dart';
import '../lead_managment/leads/data/add_lead_repo.dart';
import '../lead_managment/leads/model/add_lead_model.dart';
import '../lead_managment/import_leads/cubit/import_lead_cubit.dart';
import '../lead_managment/import_leads/data/import_lead_repo.dart';
import '../notification/cubit/notification_cubit.dart';
import '../notification/data/notification_repo.dart';
import '../reports/staff_reports/cubit/staff_activity_cubit.dart';
import '../reports/staff_reports/screen/staff_profile_screen.dart';
import '../reports/staff_reports/screen/time_line.dart';
import '../rightside_menu/call_settings.dart/cubit/call_settings_cubit.dart';
import '../rightside_menu/call_settings.dart/data/call_settings_repo.dart';
import '../rightside_menu/call_settings.dart/screen/call_settings.dart';
import '../../../core/theme/app_colors.dart';
import '../dashboard/dashboard.dart';
import '../dashboard/lead_list_screen.dart';
import '../file_manager/view/screen/view.dart';
import '../lead_managment/call_history/out_going_callHistory.dart';
import '../lead_managment/leads/screen/delete_leads/screens/delete_leads.dart';
import '../lead_managment/import_leads/screen/import_leads.dart';
import '../lead_managment/leads/screen/unassingned_leads/screen/unassingned_lead.dart';
import '../reports/rejected_leads_report/screen/rejected_leads.dart';
import '../reports/scheduled_leads/screen/scheduled_leads.dart';
import '../reports/staff_reports/screen/staff_reports.dart';
import '../reports/transfer_leads/screen/transfer_leads_report.dart';
import '../rightside_menu/custom_field_settings/cubit/custom_field_cubit.dart';
import '../rightside_menu/custom_field_settings/data/custom_field_repo.dart';
import '../rightside_menu/custom_field_settings/screen/aditional_field.dart';
...
import '../rightside_menu/lead_category/screen/lead_category.dart';
...
import '../rightside_menu/lead_source/lead_source_screen.dart';
import '../rightside_menu/lead_stage/cubit/lead_stage_cubit.dart';
import '../rightside_menu/lead_stage/screen/lead_stage.dart';
import '../rightside_menu/unassigned_settings/lead_distribution_settings.dart';
import '../settings/fb_settings/screen/facebook_settings.dart';
import '../settings/general_settings/cubit/general_settings_cubit.dart';
import '../settings/general_settings/data/general_settings_repo.dart';
import '../settings/general_settings/screen/general_settings.dart';
import '../notification/screen/notification.dart';
import 'widget/bottom_bar.dart';
import 'widget/mini_sidebar.dart';
import 'widget/profile.dart';
import 'widget/top_bar.dart';
import '../lead_managment/leads/screen/add_lead/screen/add_lead.dart';
import '../lead_managment/leads/screen/lead_report/lead_report.dart';
import '../lead_managment/call_history/call_history.dart';
import '../lead_managment/phone_call_log/phone_call_log.dart';
import '../lead_managment/leads/screen/transfer_leads/transfer_leads.dart';
import 'sidebar_item.dart';
import '../staff_managment/designation/cubit/cubit/permission_cubit.dart';
import '../staff_managment/designation/screen/permission_guard.dart';
import '../staff_managment/staff/cubit/add_staff_cubit.dart';
import '../staff_managment/staff/model/staff_model.dart';
import '../staff_managment/staff/screen/add_staff/screen/add_staff.dart';
import '../staff_managment/staff/screen/deleted_staff/screen/delete_staff.dart';
import '../staff_managment/designation/cubit/designation_cubit.dart';
import '../staff_managment/designation/model/designation_model.dart';
import '../staff_managment/designation/screen/add_designation_screen.dart';
import '../staff_managment/designation/screen/designation_screen.dart';
import '../staff_managment/staff/screen/view_staff/screen/psswrd.dart';
import '../staff_managment/staff/screen/view_staff/screen/view_staff.dart';
