...
import 'package:Odit_CRM/feature/sub_company/leads_settings_.dart/lead_category/data/sub_category_repository.dart';
...
bool leaTagExists(String name, {String? excludingId}) {
  final normalized = name.trim().toUpperCase();
  return state.leadTags.any(
